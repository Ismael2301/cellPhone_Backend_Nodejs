...
exports.deleteProduct = exports.listProduct = exports.updateProduct = exports.retrieveProduct = exports.createProduct = void 0;
const product_models_1 = require("../models/product.models");
const createProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, description, category, amount } = req.body;
    const response = yield new ProductController().create({ name, description, category, amount });
...
const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, description, category, amount } = req.body;
    const docId = req.params.id;
    const response = yield new ProductController().update(docId, { name, description, category, amount });
    return res.status(response.status).json(response);
});
...
class ProductController {
    create(producto) {
        return __awaiter(this, void 0, void 0, function* () {
            const product = new product_models_1.Product(producto);
            return product.save().then(data => {
                ...
                return { message: "Error on create Product",
                    status: 500,
                    content: err
                };
            });
    ...
    retrieve(docId) {
        return __awaiter(this, void 0, void 0, function* () {
            return product_models_1.Product.findOne({ _id: docId }).then(data => {
                if (data === null) {
                    return {
    ...
    update(docId, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return product_models_1.Product.updateOne({ _id: docId }, { $set: {
                    name: payload.name,
    ...
    delete(docId) {
        return __awaiter(this, void 0, void 0, function* () {
            return product_models_1.Product.deleteOne({ _id: docId }).then(data => {
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            return product_models_1.Product.find({}).then(data => {
                return {
